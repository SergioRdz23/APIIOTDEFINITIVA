...
/**
  ...
  * Dashboards.
  */
async function getLogMovimiento(req,res){
  try{

    var sql = constants.selectMovimiento;
...
/**
  ...
  * Dashboards.
  */
async function getLogByDateBetweenMovimiento(req,res){
  try{
    var sql = constants.selectMovimientoByDate;
...
/**
  ...
  *  
  */
async function insertLogMovimiento(req,res){
  try{

    var sql = constants.insertMovimiento;
...
module.exports = {insertLogMovimiento, getLogMovimiento,getLogByDateBetweenMovimiento};